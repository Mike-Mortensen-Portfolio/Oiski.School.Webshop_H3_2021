    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductType", x => new { x.ProductsProductID, x.TypesTypeID });
                    table.ForeignKey(
                        name: "FK_ProductType_Products_ProductsProductID",
                        column: x => x.ProductsProductID,
                        principalTable: "Products",
                        principalColumn: "ProductID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductType_Type_TypesTypeID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductType_TypesTypeID",
                table: "ProductType",
                column: "TypesTypeID");
        }
